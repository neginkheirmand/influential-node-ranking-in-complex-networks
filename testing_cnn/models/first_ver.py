...
for epoch in range(num_epochs):
    ...
    # Compute Spearman and Kendall metrics
...
print(f"Graph: {graph_name} Validation Loss: {val_loss/len(val_loader):.8f}, time: {duration}")
val_loss_list.append((graph_name, f"Validation Loss: {val_loss/len(val_loader):.8f}", duration))
